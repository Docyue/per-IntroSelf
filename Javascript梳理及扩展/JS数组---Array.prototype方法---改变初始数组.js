// ==============================Array.prototype方法
// 改变初始数组方法: pop/push/shift/unshift/reverse/splice/sort／copyWithin/fill
console.log("---------------------pop-----------------------");
...
console.log("原:"); 		console.log(arr5); // [ "Banana", "Orange", "Lemon", "Apple" ]
console.log("返回:"); 	console.log(newArr5a); // [ 'Mango' ]
// 插入元素，第二个参数可为“ ”,可插入多个元素-----修改初始数组,返回空[]
var newArr5b = arr5.splice(1,"",'gogo',"hahha");
console.log("原:"); 		console.log(arr5); // ["Banana", "gogo", "hahha", "Orange", "Lemon", "Apple"]
